...
class EpisodesControllerTest < ActionController::TestCase
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post :create, episode: { description: @episode.description, title: @episode.title, video_id: @episode.video_id }
    end
  ...
  test "should update episode" do
    patch :update, id: @episode, episode: { description: @episode.description, title: @episode.title, video_id: @episode.video_id }
    assert_redirected_to episode_path(assigns(:episode))
  end
